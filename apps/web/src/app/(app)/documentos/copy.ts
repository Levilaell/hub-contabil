...
export const copy = {
  ...
  searchResults: (n: number) => (n === 1 ? '1 documento encontrado' : `${n} documentos encontrados`),
  ...
  unassigned: {
    ...
    hint: 'Documentos recebidos que a triagem ainda não conseguiu arquivar em uma empresa.',
    resolve: 'Resolver nas Exceções',
    back: 'Documentos',
  },
  empty: {
  ...
  inbox: {
    ...
    hint: 'Suba arquivos sem escolher empresa — a IA classifica o tipo, identifica a empresa pelo CNPJ e arquiva. O que ficar em dúvida vai para as Exceções.',

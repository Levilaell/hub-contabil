...
export const copy = {
  ...
  origin: {
    ...
    channels: {
      ...
      request: 'Link de solicitação',
      triage: 'Triagem por IA (upload)',
      inbound: 'Recebido automaticamente',
    } as Record<string, string>,
    sender: 'Remetente',
    openTicket: 'Ver conversa',
    received: 'Chegou',
    classification: 'Classificação',
    classifiedByAi: (pct: number) => `IA · confiança ${pct}%`,
    classifiedByHuman: 'Confirmada por uma pessoa',
  },
  preview: {
    title: 'Documento',
    close: 'Fechar',

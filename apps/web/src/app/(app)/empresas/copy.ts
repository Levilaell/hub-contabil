...
export const copy = {
  ...
  solicitacoes: {
    ...
    addOffer: 'Disponibilizar documento',
    empty: 'Nenhuma solicitação de documento.',
    emptyHint: 'Peça um documento ao cliente por link seguro — você vê quando ele abre e envia.',
    emptyOffer: 'Nenhum documento disponibilizado.',
    emptyOfferHint:
      'Envie guias, certidões e outros arquivos por link seguro — você vê quando o cliente baixa.',
    kind: 'Tipo',
    ...
    titlePlaceholderOffer: 'Ex.: Guia DAS — competência 07/2026',
